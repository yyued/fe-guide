...
　　　　[2.3.3 文档化注释](#user-content-233-文档化注释)

　　　　[2.3.4 类型定义](#user-content-234-类型定义)

　　　　[2.3.5 文件注释](#user-content-235-文件注释)

　　　　[2.3.6 命名空间注释](#user-content-236-命名空间注释)

　　　　[2.3.7 类注释](#user-content-237-类注释)

　　　　[2.3.8 函数/方法注释](#user-content-238-函数/方法注释)

　　　　[2.3.9 事件注释](#user-content-239-事件注释)

　　　　[2.3.10 常量注释](#user-content-2310-常量注释)

　　　　[2.3.11 复杂类型注释](#user-content-2311-复杂类型注释)

　　　　[2.3.12 细节注释](#user-content-2313-细节注释)
