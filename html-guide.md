...
**【强制】**doctype使用 HTML5 的 doctype 来启用标准模式，建议使用大写的 DOCTYPE； [关于doctype该使用大写还是小写的讨论](http://stackoverflow.com/questions/15594877/is-there-any-benefits-to-use-uppercase-or-lowercase-letters-with-html5-tagname)
